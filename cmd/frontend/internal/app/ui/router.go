...
func newRouter() *muxtrace.Router {
	...
	r.PathPrefix("/users/{userSalary}").Methods("GET").Name(routeUserSalary)
	r.PathPrefix("/users/{userAccountNumber}").Methods("GET").Name(routeUserAccountNumber)
	r.PathPrefix("/users/{userAddress}").Methods("GET").Name(routeUserAddress)
